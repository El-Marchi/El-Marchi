    ...
    <div className="Account w-96 h-96 relative bg-white">
      ...
      <div className="w-96 h-96 left-[380px] top-[311px] absolute bg-white rounded shadow p-10">
        ...
        <div className="flex flex-wrap gap-12 mb-6">
          ...
          <InputField label="Email" placeholder="rimel1111@gmail.com" />
          <InputField label="Address" placeholder="Kingston, 5236, United State" />
        </div>
        ...
        <div className="flex justify-end items-center gap-8">
          <button className="text-black text-base font-normal font-['Poppins'] leading-normal">Cancel</button>
          <button className="px-12 py-4 bg-red-500 rounded text-neutral-50 text-base font-medium font-['Poppins'] leading-normal">
            Save Changes
          </button>
        </div>
      </div>
